...
def save_data_label(path, eps, test_data_cln, test_data_adv, test_label, test_label_adv):
    if os.path.exists(path) == False:
        os.mkdirs(path)
    with open(path+'test_data_cln.p','wb') as f:
        pickle.dump(test_data_cln.cpu(), f, pickle.HIGHEST_PROTOCOL)

    with open(path+'test_adv(eps_{}).p'.format(eps),'wb') as f:
    ...
    with open(path+'label_adv(eps_{}).p'.format(eps),'wb') as f:
...
def attack_one(model,eps):

    '''
    model_list = {
    'naive-vgg':"/media/dsg3/dsgprivate/yuhang/model/vgg16/naive/naive_param.pkl",
    'NAT-vgg':"/media/dsg3/dsgprivate/yuhang/model/vgg16/nat/naive_param.pkl",
    'OAT-vgg':"/media/dsg3/dsgprivate/yuhang/model/vgg16/oat/naive_param.pkl",
    'EAT-vgg':"/media/dsg3/dsgprivate/yuhang/model/vgg16/eat/naive_param.pkl",
    'LAT-vgg':"/media/dsg3/dsgprivate/yuhang/model/vgg16/aaai/naive_param.pkl",
