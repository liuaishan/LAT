...
def get_bool(string):
    if(string == 'False'):
        ...
        return True
my_file = open('/media/dsg3/dsgprivate/zhangchongzhi/model/VGG/with_dropout_log.txt','a+')
# Training settings
        ...
        for step, (x, y) in enumerate(train_loader):
            ...
            if step % 100 == 0:
                ...
                if args.enable_lat:
                    ...
                    torch.save(model.state_dict(), args.model_path + 'naive_param_with_dropout.pkl')
...
if __name__ == "__main__":
    if args.enable_lat:
        ...
        real_model_path = args.model_path + "naive_param_with_dropout.pkl"
