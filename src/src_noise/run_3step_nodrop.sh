python main.py \
  ...
  --model_path "/media/dsg3/dsgprivate/yuhang/model/resnet50/lat/noise_3step_nodrop/" \
  --pro_num 1 \
  --alpha 0 \
  --epsilon 0 \
  --dataset "cifar10" \
