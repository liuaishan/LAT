                ...
                if args.model == 'resnet':
                    if args.enable_lat:
                        model.z0_reg.data = args.alpha * model.z0_reg.data + \
                                          model.z0.grad / torch.norm(torch.norm(torch.norm(model.z0.grad, p = 2,dim = 2),p = 2,dim = 2),p = 2,dim = 1).view(args.batchsize,1,1,1).repeat(1,64,32,32)
...
def test_one(model,data_cat,data_path):
    ...
    label_path = "/media/dsg3/dsgprivate/lat/test_cw/test_label.p"
...
def test_all():
    ...
    resnet_model_list = {
    'naive-resnet':"/media/dsg3/dsgprivate/yuhang/model/resnet50/naive/naive_param.pkl",
    'new-AT-resnet':"/media/dsg3/dsgprivate/yuhang/model/resnet50/nat/naive_param.pkl",
    'origin-AT-resnet':"/media/dsg3/dsgprivate/yuhang/model/resnet50/oat/naive_param.pkl",
    'ensemble-AT-resnet':"/media/dsg3/dsgprivate/yuhang/model/resnet50/eat/naive_param.pkl",
    'LAT-aaai-resnet':"/media/dsg3/dsgprivate/yuhang/model/resnet50/aaai/naive_param.pkl",
    'DPLAT-resnet50':"/media/dsg3/dsgprivate/yuhang/model/resnet50/dplat/lat_param.pkl", 
    'DPLAT-resnet18':"/media/dsg3/dsgprivate/yuhang/model/resnet50/dplat-18/lat_param.pkl",   
    }
    vgg_model_list = {
    'naive-vgg':"/media/dsg3/dsgprivate/yuhang/model/vgg16/naive/naive_param.pkl",
    'new-AT-vgg':"/media/dsg3/dsgprivate/yuhang/model/vgg16/nat/naive_param.pkl",
    'origin-AT-vgg':"/media/dsg3/dsgprivate/yuhang/model/vgg16/oat/naive_param.pkl",
    'ensemble-AT-vgg':"/media/dsg3/dsgprivate/yuhang/model/vgg16/eat/naive_param.pkl",
    'LAT-aaai-vgg':"/media/dsg3/dsgprivate/yuhang/model/vgg16/aaai/naive_param.pkl",
    'PLAT-vgg':"/media/dsg3/dsgprivate/yuhang/model/vgg16/plat/lat_param.pkl",
    'DPLAT-vgg':"/media/dsg3/dsgprivate/yuhang/model/vgg16/dplat/lat_param.pkl",
    }
    
    data_list = {
    'k3c0.03-vgg':"/media/dsg3/dsgprivate/lat/test_cw/test_adv(k3c0.030).p",
    'k5c0.05-vgg':"/media/dsg3/dsgprivate/lat/test_cw/test_adv(k5c0.050).p",
    'k3c0.03-resnet':"/media/dsg3/dsgprivate/lat/test_cw/resnet/test_adv(k3c0.030).p",
    'k5c0.05-resnet':"/media/dsg3/dsgprivate/lat/test_cw/resnet/test_adv(k5c0.050).p",
    }
